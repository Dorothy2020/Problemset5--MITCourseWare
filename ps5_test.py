...
class ProblemSet5(unittest.TestCase):
    ...
    def test8FilterStories2(self):
        a = NewsStory('', "asfd  Nairobi asfdasdfasdf", '', '', datetime.now())
        b = NewsStory('', "asdfasfd nNairobi city! asfdasdfasdf", '', '', datetime.now())
        noa = NewsStory('', "something somethingnew Nairobi city", '', '', datetime.now())
        nob = NewsStory('', "something something new Nairobi cities", '', '', datetime.now())
